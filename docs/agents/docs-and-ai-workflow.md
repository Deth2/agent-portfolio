...
| --- | --- | --- |
| [domain.md](./domain.md) | Tells exploration/refactor skills to read `CONTEXT.md` and relevant ADRs *before* exploring, use the glossary's exact terms, and flag (not silently override) ADR conflicts. | `/domain-modeling`, `/grill-with-docs`, `/improve-codebase-architecture` |
